        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-md-4 col-sm-12">
                    <h1 className="mb-5" style={{ fontWeight: 'bold' }}> <span style={{ color: 'goldenrod' }}>XRX-Online</span> <br /> <span style={{ color: 'goldenrod' }}>Library</span></h1>
                    ...
                    <Link to="/BookListUser" ><button className="btn btn-primary main-btn">GET BOOK</button></Link>
                </div>
